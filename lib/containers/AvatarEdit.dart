...
import 'package:medic_book/widgets/common/FullScreenWrapper.dart';
...
class _AvatarEditState extends State<AvatarEdit> {
  ...
  final List<Map<String, dynamic>> _actionListData = [
    {'title': 'التقط صورًا', 'value': 'takePhoto'},
    {'title': 'ألبوم صور', 'value': 'ablum'},
    {'title': 'حفظ الصورة', 'value': 'saveImage'},
  ];
  String _activeKey;
