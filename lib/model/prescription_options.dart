...
PrescriptionOptions prescriptionOptionsFromJson(String str) =>
    PrescriptionOptions.fromJson(json.decode(str));

String prescriptionOptionsToJson(PrescriptionOptions data) =>
...
class PrescriptionOptions {
  ...
  factory PrescriptionOptions.fromJson(Map<String, dynamic> json) =>
      PrescriptionOptions(
