...
import 'package:medic_book/containers/AvatarEdit.dart';

class BasicInfo extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final String avatarImage =
        'https://www.hijozaty.com/profile_images/5e31ae94d6a8a.png';
    final List<Map<String, dynamic>> _statistics = [
      {'key': 'attention', 'value': 818},
      {'key': 'Followers', 'value': 900, 'border': true},
      {'key': 'like', 'value': 1000}
    ];
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      image: DecorationImage(image: NetworkImage(avatarImage))),
                ),
              ),
              SizedBox(
                width: 16.0,
