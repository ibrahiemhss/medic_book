...
import 'package:medic_book/widgets/Leaderboard/CrownAvatar.dart';
      ...
      child: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            CommonTitle(title: "Latest author"),
            Container(
              margin: EdgeInsets.symmetric(vertical: 24.0),
              height: 140.0,
              child: ListView(
            ...
            CommonTitle(title: "Other authors"),
            Container(
              margin: EdgeInsets.symmetric(vertical: 24.0),
              height: 140.0,
              child: ListView(
